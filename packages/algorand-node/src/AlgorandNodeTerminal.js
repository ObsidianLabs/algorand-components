...
function parseLine(line) {
  ...
  if (match && match[1]) {
    algorandNode.updateBlockNumber(match[1])
  }
  return line
}
...
export default class AlgorandNodeTerminal extends PureComponent {
  constructor (props) {
    super(props)
